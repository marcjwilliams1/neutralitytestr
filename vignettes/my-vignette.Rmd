---
title: "neutralitytestr.R: Testing a neutral evolutionary model on cancer sequencing data "
...
After you have installed the package with ```devtools::install_github("marcjwilliams1/neutralitytestr")```, you can load the package via the normal command. This will also load some test data. 
